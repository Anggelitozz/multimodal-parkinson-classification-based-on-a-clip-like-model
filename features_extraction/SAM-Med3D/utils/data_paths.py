...
# # img_datas = glob(osp.join(PROJ_DIR, "data", "train", "*", "*MRI"))
# img_datas = glob(osp.join(PROJ_DIR, "data", "train_test", "*", "SPECT"))
img_datas = glob(osp.join(PROJ_DIR, "data", "train_test", "*", "MRI_brain-stem"))
