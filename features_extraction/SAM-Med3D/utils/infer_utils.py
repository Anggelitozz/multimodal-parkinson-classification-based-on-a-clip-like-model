...
def sam_model_infer(model,
    ...
    with torch.no_grad():
        ...
        for _ in range(num_clicks):
            ...
            # # Interpolación a la resolución original
            ...
            #     os.makedirs("embeddings_decoder_spect", exist_ok=True)
            #     np.save(f"embeddings_decoder_spect/{case_name}.npy", upscaled_embed)
